...
class DataConfig{
	...
	*/
	...
	/*! add field to dataset database ($text collection)
	...
	*/	
	...
	/*! remove field from dataset database ($text collection)
	...
	*/
	...
	/*! remove field from dataset database ($text and $data collections)
